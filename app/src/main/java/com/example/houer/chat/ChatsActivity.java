...
import com.example.houer.userKetNoi.NguoiKetNoiAdapter;
...
public class ChatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatLayoutManager = new LinearLayoutManager(ChatsActivity.this);
        mRecyclerView.setLayoutManager(mChatLayoutManager);
        mChatAdapter = new ChatAdapter(getDataSetChat(), ChatsActivity.this);
