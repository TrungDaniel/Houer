...
public class SettingUsersActivity extends AppCompatActivity {
    ...
    private FirebaseStorage filePath = FirebaseStorage.getInstance();
    ...
    private void saveUserInformation() {
        ...
        if (name.matches("") || phone.matches("")) {
            Toast.makeText(this, "dien day du thong tin", Toast.LENGTH_SHORT).show();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                Toast.makeText(SettingUsersActivity.this, "done", Toast.LENGTH_SHORT).show();
                                uploadUri(uri);
